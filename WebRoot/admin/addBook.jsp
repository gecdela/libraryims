...
<div class="col-md-5 col-md-offset-4">
   <form class="bs-example bs-example-form" action="servlet/bookServlet?method=add"method="post"role="form">
             <h2 style="text-align:center">新增图书</h2>
						<div class="form-group">
							<div class="row">
								<label for="bookname" class="col-sm-2 control-label">书名</label>
								<div class="col-sm-9">
									<input type="text" class="form-control" value="" id="add_bname"
							...
							<div class="row">
								...
								<div class="col-sm-9">
									<input type="text" class="form-control" id="add_bprice"
										name="bookPrice" placeholder="请输价格">
								</div>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="col-sm-offset-2 col-sm-4">
							<input type="submit" class="btn btn-default btn-block" onClick="addInfo()">
						</div>
						<div class="col-sm-4">
